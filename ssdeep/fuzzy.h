 ...
 */
__declspec(dllexport) /*@only@*/ /*@null@*/ struct fuzzy_state *fuzzy_new(void);
 ...
 */
__declspec(dllexport) /*@only@*/ /*@null@*/ struct fuzzy_state *fuzzy_clone(const struct fuzzy_state *state);
 ...
 */
__declspec(dllexport) int fuzzy_set_total_input_length(struct fuzzy_state *state, uint_least64_t total_fixed_length);
 ...
 */
__declspec(dllexport) int fuzzy_update(struct fuzzy_state *state,
 ...
 * @return zero on success, non-zero on error
 */
__declspec(dllexport) int fuzzy_digest(const struct fuzzy_state *state,
			/*@out@*/ char *result,
			unsigned int flags);
 ...
 */
__declspec(dllexport) void fuzzy_free(/*@only@*/ struct fuzzy_state *state);
 ...
 */
__declspec(dllexport) int fuzzy_hash_buf(const unsigned char *buf,
 			  uint32_t buf_len,
 			  /*@out@*/ char *result);
 ...
 * @return Returns zero on success, non-zero on error
 */
__declspec(dllexport) int fuzzy_hash_file(FILE *handle, /*@out@*/ char *result);
 ...
 * @return Returns zero on success, non-zero on error
 */
__declspec(dllexport) int fuzzy_hash_stream(FILE *handle, /*@out@*/ char *result);
...
__declspec(dllexport) int fuzzy_compare(const char *sig1, const char *sig2);
